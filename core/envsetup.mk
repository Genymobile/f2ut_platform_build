...
# On OS X by default using local initrd and prebuilt kernel
ifeq ($(HOST_OS),darwin)
...
TARGET_COPY_OUT_UBUNTU_INITRD := initrd
TARGET_COPY_OUT_UBUNTU_RAMDISK := ramdisk
TARGET_COPY_OUT_UBUNTU_CUSTOM := custom
TARGET_COPY_OUT_UBUNTU_ROOTFS := rootfs
###########################################
...
TARGET_OUT_UBUNTU_RAMDISK := $(TARGET_OUT_UBUNTU)/$(TARGET_COPY_OUT_UBUNTU_RAMDISK)
TARGET_OUT_UBUNTU_INITRD := $(TARGET_OUT_UBUNTU)/$(TARGET_COPY_OUT_UBUNTU_INITRD)
TARGET_OUT_UBUNTU_ROOTFS := $(TARGET_OUT_UBUNTU)/$(TARGET_COPY_OUT_UBUNTU_ROOTFS)
TARGET_OUT_UBUNTU_CUSTOM := $(TARGET_OUT_UBUNTU)/$(TARGET_COPY_OUT_UBUNTU_CUSTOM)
